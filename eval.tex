...
\sys discovered 7 integer errors, where kernel developers had written checks,
but the checks were incorrect or insufficient.
The ``\# of prev. checks'' column in \autoref{f:data:linux} counts
the those checks that were committed into the mainline repository.
...
\xw{this doesn't match the data.
we wanted to show the number of generations
of bad checks.  36 is not really what we wanted.}
