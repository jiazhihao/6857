...
snippets.  Ideally \sys should catch the bugs in the orignal code,
...
shift.  It then leads to a divison-by-zero bug in the subsequent
use as a divisor.
...
There is one false error in CVE-2011-4097 (oom).
...
CVE-2010-4164.  The other four contain either new errors or the patch
is wrong, as we have discussed in \autoref{s:eval:linux}.
