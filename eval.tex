...
\item
How long does it take to analyze a large system such
as the Linux kernel?
\end{itemize}
...
did not apply it for unknown reasons.
\item
...
we submitted; they withdrew these modifications after discussion on the
mailing list.
...
fixed incorrectly.  One of them was fixed three times before our
patch was accepted.
...
This shows that \sys's reports is fairly complete.
...
\subsubsection{Missed Bugs in Original Code}
...
\subsubsection{False and New Bugs in Patched Code}

We additional tested \sys on the patched code of these cases
...
3.2 source code, on a testing machine with 12 CPU cores.  We set the timeout
to 5 seconds for each constraint solving query.   \sys analyzed
8637 files, 10 of which timeouts, and made 411,851 solving queries.
