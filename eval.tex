...
sizes.  Out of the 1,024 reported allocation size errors, only 646 are derived
from untrusted inputs.  We scaned through them and inspected 97 reports in
detail.  It took us roughly 12 hours to discover the first batch of 6
exploitable bugs.  The other 91 warnings are either harmless overflows or false
warnings.  Most of the false warnings are due to either imprecise range
