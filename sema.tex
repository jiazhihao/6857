...
\sys assumes two's complement~\cite[\S4.2.1]{intel:vol1},
...
\centering
\input{code/ext4}
\nz{What's the error in this code sequence?  Regardless of what
the if statement does, the convert\_to\_initialized function
returns the same thing -- the value of {\tt allocated}.}
\vspace{-1em}
...
A variable that is used as a data size \nz{how do you know if something
is used as a data size?  annotations?} or an array index should be
non-negative.
