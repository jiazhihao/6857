...
arithemtic: wrapping semantics.

division by zero?

shifts: follow x86's semantics (also ARM and MIPS), using 5~bits
as the shift amount for a 32-bit shift.  \sys does not model PowerPC's
behavior, where 6~bits are used.
