...
\begin{figure}
\centering
\nz{It would be good to show ->read\_status() returning -1.}
...
\sys uses annotations to specify data size parameters.
...
\cc{sizeof(int)} is unsigned, and \cc{optlen} is considered as
