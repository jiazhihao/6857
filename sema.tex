...
\multicolumn{3}{l}{Integer operation} & In-range requirement \\
\midrule
...
out.  Therefore, \sys considers $x \shl 1$ always in range, while
$x \times_u 2$ is not.
...
As explained in \autoref{s:sema:sec}, \sys imposes different in-range
