...
e.g., passing an \cc{int} as a function parameter of type \cc{unsigned
int}, and vice versa.  Though the conversion may not be conforming
...
\paragraph{Chained operations.}
$x +_u 2 -_u 1$ with $x \geq_u 1$

\paragraph{Checking idioms.}
$\cc{UINT_MAX} - x > y$
vs.
$x +_u y <_u x$
