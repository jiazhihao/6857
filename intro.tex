...
multiplication of \cc{maxnum}, a value controlled by userspace,
...
an overflowed product \cc{size} will bypass the sanity check and
reach the \cc{kmalloc} call.
...
and apply it to XXX.  XXX patches have been upstreamed..
