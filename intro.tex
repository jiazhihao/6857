...
kernel~(CVE-2006-5751).  The size for allocating \cc{buf} is calculated
from the multiplication of \cc{maxnum}, an integer read from user
...
expressions such as $x + y < x$~\cite{ioc}, which \sys should not consider as
