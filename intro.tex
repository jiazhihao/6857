...
Applying \sys to the Linux kernel and user-space applications
(including lighttpd and OpenSSH) results in 20+ patchsets that have
fixed more than 50 integer errors upstream.  It also reveals that
...
kernel source tree and known CVE cases.  \autoref{s:miti} discusses
mitigation strategies to integer errors.  We relate \sys to previous
work in \autoref{s:relwk}, and then conclude in \autoref{s:concl}.
