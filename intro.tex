...
\autoref{f:bridge} shows an integer error in the Linux
kernel (CVE-2006-5751).  The size for allocating \cc{buf} is computed
...
\xw{first part is static analysis / a study of the linux kernel
(i.e., how bad the situation is).
then we discuss about mitigation strategies.
could move design challenges to section 2.
}
