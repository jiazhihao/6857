...
\cc{kmalloc} may be substituted with \cc{kcalloc}, too.
...
is worth noting that, however, allocate elements in C++ like \cc{new
...
\cc{tolower} returns a signed \cc{int}, which happend to the Apache
