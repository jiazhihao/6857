...
when generating predicates across functions (i.e., for function parameters,
return values, global variables, and structure fields),
...
maps each of the aforementioned cross-function values to its range. Initially, all
