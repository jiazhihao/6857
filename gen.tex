...
this paper.\fk{Can we delete the last sentence?  it doesn't see to be our
  contribution; we seem to be exploiting features that Boolean has for this case.}
...
Error and path predicates are generated on a per-function basis, and do not
