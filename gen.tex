...
like \cc{memcpy}, \cc{copy_from_user}, and \cc{sock_alloc_send_skb}.
...
\hc{a bit hard to follow, should we say loop invariants?}
...
and structure fields), \sys bounds each integer-typed entity using two constant
...
accesses to a cross-function entity, such as loads from a structure field or a
