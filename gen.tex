...
and structure fields), \sys bounds each integral entity using two constant
...
their \cc{sysctl} table entries.  \sys understands the \cc{sysctl} structures
and extracts the bounds from these entries.
