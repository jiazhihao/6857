...
This section relates \sys to existing work.  \fk{It would be better to start
  with a statement saying what is novel about \sys, which makes it clear which
  work is related and will be covered in this section. We may want to consider
  moving it up; so that we can talk about previous tools early on and say why
  they are not good enough, underscoring the challenges of doing it right and
  our primary contributions.  Some subsections don't relate \sys to other
  approaches.}
