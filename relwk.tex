...
Using them to find integer errors, however, requires carefully chosen
input that can trigger those bugs.
Therefore they are in general difficult to achieve high coverage.
