...
Verification tools such as ArC~\cite{arc} and Jessie~\cite{jessie}
can catch integer errors, but they only accept a restrictive subset
of C (e.g., no function pointers) and cannot apply to systems like
the Linux kernel.
...
%In particular, because triggering integer errors often requires
